export default function polyfillFontFaceObserver() {
  function e( e, t ) {
    ...
    return new Promise( function( e, i ) {
      ...
      if ( f ) {
        ...
        var p = new n( a ),
          ...
          L = 0;
        C.dir = "ltr", r( p, c( o, "sans-serif" ) ), r( d, c( o, "serif" ) ), r( v, c( o, "monospace" ) ), C.appendChild( p.a ), C.appendChild( d.a ), C.appendChild( v.a ), document.body.appendChild( C ), x = p.a.offsetWidth, T = d.a.offsetWidth, N = v.a.offsetWidth, f(), s( p, function( e ) {
          m = e, t()
