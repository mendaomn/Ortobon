...
class ShopifyManager {
  static get SDK_URL () {
    return process.env.NODE_ENV === 'production'
      ...
      : 'https://sdks.shopifycdn.com/buy-button/latest/buy-button-storefront.js'
  }
  ...
  static async update (data) {
    return new Promise(async (resolve, reject) => {
      const shouldCreateProduct = await ShopifyManager.shouldCreateProduct(
        data
      )
      ...
      if (shouldCreateProduct) {
        ...
        const putRes = await ShopifyManager.put(
          GET_PRODUCT_URL(data.shopifyID),
          payload
        )
